...
The software audited — **Git** — is licensed under the **GNU General Public License v2 (GPL v2)**. Full license text: [https://www.gnu.org/licenses/old-licenses/gpl-2.0.html](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html)